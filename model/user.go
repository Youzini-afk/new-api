...
type User struct {
	...
	DiscordUsername        string         `json:"discord_username" gorm:"column:discord_username;type:varchar(128)"`
	DiscordGlobalName      string         `json:"discord_global_name" gorm:"column:discord_global_name;type:varchar(128)"`
	DiscordDiscriminator   string         `json:"discord_discriminator" gorm:"column:discord_discriminator;type:varchar(16)"`
	DiscordAvatarHash      string         `json:"-" gorm:"column:discord_avatar_hash;type:varchar(128)"`
	DiscordProfileSyncedAt int64          `json:"discord_profile_synced_at" gorm:"column:discord_profile_synced_at"`
	...
	AvatarURL              string         `json:"avatar_url" gorm:"column:avatar_url;type:varchar(1024)" validate:"omitempty,max=1024"`
	AvatarSource           string         `json:"avatar_source" gorm:"column:avatar_source;type:varchar(32)" validate:"omitempty,max=32"`
...
func HardDeleteUserById(id int) error {
	...
	return DB.Transaction(func(tx *gorm.DB) error {
		...
		if err := DeleteUserAvatarWithDB(tx, id); err != nil {
			return err
		}
...
func (user *User) Delete() error {
	...
	if err := DB.Transaction(func(tx *gorm.DB) error {
		if err := DeleteUserAvatarWithDB(tx, user.Id); err != nil {
			return err
		}
