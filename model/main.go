...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		// Phase 7B — paid instant spin roulette (default disabled; 旧 gy 6 人满员正期望 roulette 不迁移).
		&GameLotteryRound{},
		&GameLotteryTicket{},
		&GameRouletteSpin{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&GameRouletteSpin{}, "GameRouletteSpin"},
		{&GameRouletteDailyUser{}, "GameRouletteDailyUser"},
		{&SubscriptionOrder{}, "SubscriptionOrder"},
		{&UserSubscription{}, "UserSubscription"},
		{&SubscriptionPreConsumeRecord{}, "SubscriptionPreConsumeRecord"},
		{&CustomOAuthProvider{}, "CustomOAuthProvider"},
		{&UserOAuthBinding{}, "UserOAuthBinding"},
		{&ExternalAppAuthCode{}, "ExternalAppAuthCode"},
		{&ExternalQuotaOperation{}, "ExternalQuotaOperation"},
