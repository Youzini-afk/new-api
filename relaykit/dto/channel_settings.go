...
// ChannelTrafficControl limits actual upstream requests for one channel. A
// zero concurrency or RPM value disables only that dimension. QueueSize zero
// makes admission fail fast instead of waiting.
