...
import { getGovernanceSectionNavItems } from '@/features/system-settings/governance/section-registry.tsx'
  ...
  return [
    {
      ...
      items: [
        ...
        {
          title: t('Relay Governance'),
          icon: TriangleAlert,
          items: getGovernanceSectionNavItems(t),
        },
        {
