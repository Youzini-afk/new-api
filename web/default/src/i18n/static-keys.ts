...
export const STATIC_I18N_KEYS = [
  ...
  'Last check:',
  'Login Gate Enabled',
  'Login Gate uses the same Discord Gate config as Register Gate. Existing users who previously passed may continue when Discord returns a temporary unknown result.',
  'Mark Discord exempt',
  'Message:',
  ...
  'Discord gate patrol',
  'Discord API rate limit across workers. (1–50)',
  'Concurrent Discord API workers. (1–32)',
  ...
  'Patrol status',
  'Periodically rechecks existing Discord users against the configured gate: banned guilds and required guild/role conditions. Users missing the guilds scope only need to reauthorize — their token is not disabled.',
