...
const defaultAuthSettings: AuthSettings = {
  ...
  'discord.login_gate_patrol_interval_minutes': 5,
  'discord.login_gate_patrol_target_sweep_hours': 24,
  'discord.login_gate_patrol_max_batch_size': 1000,
  'discord.login_gate_patrol_worker_count': 8,
  'discord.login_gate_patrol_max_rps': 8,
  'discord.login_gate_patrol_max_retries': 3,
  'oidc.enabled': false,
  'oidc.client_id': '',
  'oidc.client_secret': '',
  'oidc.well_known': '',
