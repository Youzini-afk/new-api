  ...
  return (
    <main className='bg-background text-foreground relative h-svh min-h-svh w-full overflow-hidden'>
      ...
      <section className='pointer-events-none relative z-10 flex h-svh min-h-svh flex-col items-center justify-center px-5 text-center'>
        <h1
          className='landing-animate-scale-in overflow-visible bg-gradient-to-r from-[#4db6ac] via-[#c5e1a5] to-[#fdd835] bg-clip-text py-[0.14em] text-[clamp(4.5rem,13vw,10rem)] leading-[1.18] font-normal tracking-[-0.04em] text-transparent select-none dark:from-[#80cbc4] dark:via-[#dcedc8] dark:to-[#ffe14d]'
          style={{
