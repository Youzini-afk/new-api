...
func GetSelf(c *gin.Context) {
	...
	responseData := map[string]interface{}{
		...
		"discord_profile_synced_at": user.DiscordProfileSyncedAt,
		"discord_gate_passed":       user.DiscordGatePassed,
		"discord_gate_exempt":       user.DiscordGateExempt,
		"discord_last_check_at":     user.DiscordLastCheckAt,
		"discord_last_check_result": user.DiscordLastCheckResult,
		"discord_last_check_reason": user.DiscordLastCheckReason,
		"discord_gate_message":      user.DiscordGateMessage,
		"oidc_id":                   user.OidcId,
