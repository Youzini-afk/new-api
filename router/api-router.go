...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/external-game", controller.GetExternalGameSettings)
			optionRoute.PUT("/external-game", controller.UpdateExternalGameSettings)
		...
		errorInsightRoute.Use(middleware.AdminAuth())
		{
			...
			errorInsightRoute.GET("/governance-ai/settings", controller.GetErrorGovernanceAISetting)
			errorInsightRoute.PUT("/governance-ai/settings", controller.SaveErrorGovernanceAISetting)
			errorInsightRoute.POST("/governance-ai/organize", controller.GenerateErrorGovernanceAIOrganization)
